"""
Django settings for PickYourLiquor project.
...
SECRET_KEY = 'i%5#=u0@r%fn6&+@k9-$op8p(77*3u87$e3cbrg^6k4iu5l(a)'
...
ROOT_URLCONF = 'PickYourLiquor.urls'
...
WSGI_APPLICATION = 'PickYourLiquor.wsgi.application'
